...
"[project]/lib/prime-narrative.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "generatePrimeBriefingMode",
    ()=>generatePrimeBriefingMode,
    "generatePrimeInsightsFeed",
    ()=>generatePrimeInsightsFeed,
    "generatePrimeMonthlyDigest",
    ()=>generatePrimeMonthlyDigest,
    "generatePrimeNarrativeBundle",
    ()=>generatePrimeNarrativeBundle,
    "generatePrimeWeeklyReport",
    ()=>generatePrimeWeeklyReport
]);
function generatePrimeWeeklyReport(insights) {
    return insights.map((i)=>`${i.title}: ${i.narrative}`);
}
function generatePrimeMonthlyDigest(insights) {
    return insights.slice(0, 7).map((i)=>`Monthly: ${i.title} (${i.reliabilityScore})`);
}
function generatePrimeInsightsFeed(insights) {
    return insights.slice(0, 5).map((i)=>`${i.scope.toUpperCase()}: ${i.title} — ${i.narrative}`);
}
function generatePrimeBriefingMode(persona, briefing) {
    const lines = [];
...
function generatePrimeNarrativeBundle(params) {
...
"[project]/lib/prime-intel.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "computeGlobalReliabilityScore",
    ()=>computeGlobalReliabilityScore,
    "correlateAcrossTenants",
    ()=>correlateAcrossTenants,
    "detectGlobalPatterns",
    ()=>detectGlobalPatterns,
    "generatePrimeBriefing",
    ()=>generatePrimeBriefing,
    "generatePrimeInsights",
    ()=>generatePrimeInsights
]);
function correlateAcrossTenants(incidents) {
    return incidents;
}
function detectGlobalPatterns(patterns) {
    return patterns.slice(0, 5);
}
function computeGlobalReliabilityScore(incidents) {
...
function generatePrimeInsights(incidents, patterns) {
...
function generatePrimeBriefing(incidents, patterns) {
    const reliabilityScore = computeGlobalReliabilityScore(incidents);
    const highlights = [];
...
"[project]/lib/knowledge-graph.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "buildKnowledgeGraph",
    ()=>buildKnowledgeGraph,
    "buildKnowledgeGraphInsights",
    ()=>buildKnowledgeGraphInsights,
    "buildKnowledgeRecommendations",
    ()=>buildKnowledgeRecommendations,
    "linkFixesToPlaybooks",
    ()=>linkFixesToPlaybooks,
    "linkIncidentsToPatterns",
    ()=>linkIncidentsToPatterns,
    "linkPatternsToFixes",
    ()=>linkPatternsToFixes,
...
function linkIncidentsToPatterns(graph) {
    const links = [
        ...graph.links
    ];
...
function linkPatternsToFixes(graph) {
    const links = [
        ...graph.links
    ];
    graph.patterns.forEach((pat)=>{
...
function linkFixesToPlaybooks(graph) {
    const links = [
        ...graph.links
    ];
    graph.proposals.forEach((prop)=>{
...
function buildKnowledgeGraphInsights(graph) {
    const insights = [];
    if (!graph.incidents.length && !graph.patterns.length) {
        return [
            "Knowledge graph has no recent signals."
        ];
    }
...
function buildKnowledgeRecommendations(graph) {
    const recs = [];
    ...
    recs.push({
        ...
        actions: [
            "Pair with closest playbook",
            "Run tabletop rollback simulation",
...
"[project]/lib/prime-knowledge.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "evolveKnowledgeGraph",
    ()=>evolveKnowledgeGraph,
    "knowledgeBrainBundle",
    ()=>knowledgeBrainBundle
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/knowledge-graph.ts [app-route] (ecmascript)");
;
function evolveKnowledgeGraph(input) {
    let graph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildKnowledgeGraph"])(input);
    graph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["linkIncidentsToPatterns"])(graph);
    graph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["linkPatternsToFixes"])(graph);
    graph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["linkFixesToPlaybooks"])(graph);
    return graph;
}
function knowledgeBrainBundle(input) {
    const graph = evolveKnowledgeGraph(input);
    const insights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildKnowledgeGraphInsights"])(graph);
    const recommendations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildKnowledgeRecommendations"])(graph);
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2d$graph$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["summarizeKnowledgeGraph"])(graph);
    return {
        graph,
        insights,
        recommendations,
...
"[project]/lib/persona.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/operator-prime.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "buildOperatorPrimeBundle",
    ()=>buildOperatorPrimeBundle
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$narrative$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prime-narrative.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prime-intel.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$knowledge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prime-knowledge.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persona$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/persona.ts [app-route] (ecmascript)");
;
;
;
;
;
;
function buildOperatorPrimeBundle(input) {
    const persona = input.persona ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$persona$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defaultPersona"];
    ...
    const autonomy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$autonomy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeAutonomyBundle"])(incidents);
    const primeInsights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeInsights"])(incidents, patterns);
    const primeBriefing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeBriefing"])(incidents, patterns);
    const primeNarrative = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$narrative$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeNarrativeBundle"])({
        insights: primeInsights,
        briefing: primeBriefing,
        persona
    });
    const primeFeed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$narrative$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeInsightsFeed"])(primeInsights);
    const primeWeeklyReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$narrative$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeWeeklyReport"])(primeInsights);
    const primeMonthlyDigest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$narrative$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePrimeMonthlyDigest"])(primeInsights);
    const globalReliabilityScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeGlobalReliabilityScore"])(incidents);
    const knowledgeBrain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prime$2d$knowledge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["knowledgeBrainBundle"])({
        incidents,
        patterns,
...
"[project]/app/api/intel/prime/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/intel.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/knowledge.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operator$2d$prime$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/operator-prime.ts [app-route] (ecmascript)");
...
;
async function GET() {
    const incidents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRecentIncidents"])(200);
    const patterns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$intel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIncidentPatterns"])(15);
    const playbooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$playbooks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listPlaybooks"])();
    const articles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$knowledge$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listKnowledgeArticles"])();
    const operatorPrime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$operator$2d$prime$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildOperatorPrimeBundle"])({
        incidents,
        patterns,
        playbooks,
        articles
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4cf21711._.js.map