...
export const metadata: Metadata = {
  title: "Color Palette Generator — Build With AI",
  description: "Create color palettes from brand adjectives, references, or existing assets.",
}
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col gap-10 px-6 py-16 md:px-10 md:py-20 font-inter text-sm">
        <section className="space-y-3 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm md:text-base text-muted-foreground">
            Explore palettes built from brand adjectives, references, or uploaded assets — tuned for cinematic UI.
          </p>
        </section>
      </main>
    </div>
