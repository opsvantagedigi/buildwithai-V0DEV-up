...
export const metadata: Metadata = {
  title: "Domain Name Generator — Build With AI",
  description: "Explore domain and name ideas grounded in your product and audience.",
}

export default function DomainsToolPage() {
  return (
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col gap-10 px-6 py-16 md:px-10 md:py-20 font-inter text-sm">
        <section className="space-y-3 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm md:text-base text-muted-foreground">
            Generate brand and domain ideas that feel cinematic, memorable, and aligned with your audience.
          </p>
        </section>
      </main>
    </div>
