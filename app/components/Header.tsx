                    ...
                    <ul className="mt-2 space-y-1">
                      <li>
                        <Link
                          ...
                          className="block rounded-md px-2 py-1.5 hover:bg-slate-100"
                        >
            ...
            <div className="relative">
              ...
              >
                <ul className="space-y-1">
                  ...
                  <li>
                    <Link
                      href="/ai-tools/mission-statement-generator"
                      className="block rounded-md px-2 py-1.5 hover:bg-slate-100"
                    >
                  ...
                  <li>
                    <Link
                      href="/ai-tools/vision-statement-generator"
                      className="block rounded-md px-2 py-1.5 hover:bg-slate-100"
                    >
                  ...
                  <li>
                    <Link
                      href="/ai-tools/industry-explorer"
                      className="block rounded-md px-2 py-1.5 hover:bg-slate-100"
                    >
                      Industry Explorer
                    </Link>
