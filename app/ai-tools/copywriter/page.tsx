...
export const metadata: Metadata = {
  title: "Copywriter — Build With AI",
  description: "Draft cinematic headlines, subcopy, and microcopy in your brand voice.",
}

export default function CopywriterToolPage() {
  return (
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col gap-10 px-6 py-16 md:px-10 md:py-20 font-inter text-sm">
        <section className="space-y-3 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm md:text-base text-muted-foreground">
            Draft headlines, body copy, and microcopy that sound like you — consistent across every page and launch.
          </p>
        </section>
      </main>
    </div>
