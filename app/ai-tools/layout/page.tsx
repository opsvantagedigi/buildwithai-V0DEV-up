...
export const metadata: Metadata = {
  title: "Layout Generator — Build With AI",
  description: "Turn a short prompt into cinematic, full-page layouts with sections and CTAs.",
}
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col gap-10 px-6 py-16 md:px-10 md:py-20 font-inter text-sm">
        <section className="space-y-3 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm md:text-base text-muted-foreground">
            Turn a single sentence into a cinematic layout with hero, story, features, pricing, and more.
          </p>
        </section>
      </main>
    </div>
